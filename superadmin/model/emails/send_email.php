            ...
            return '<div style="background-color:#f2f3f5;padding:20px">
              ...
                          <div style="padding:0px 30px">        
                              <div style="font-size:16px;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:20px">        
                                  ...
                                  <p style="text-align:center;"><a style="text-decoration:none;color:#000"></a><b>T4M Support Team</b></p>        
                              </div>
            ...
            return '<div style="background-color:#f2f3f5;padding:20px">
                  ...
                            <div style="padding:0px 30px">        
                          <div style="font-size:16px;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:20px">        
                            ...
                            <p style="text-align:center; margin: 0;"><a style="text-decoration:none;color:#000"></a>See you inside!<br /><b>T4M Support Team</b></p>        
                          </div>
                              <div style="font:11px sans-serif;color:#686f7a">
                          <p style="margin: 0;">© 2021. Trans4m Inc.</p>    
                          </div>        
