                    ...
                    <div class="col">
                        <div class="card card-custom bg-dark card-stretch gutter-b">
                            <div class="card-body">
                                ...
                                <a id="quiz-summary-btn" class="font-weight-bold" data-toggle="collapse"></i>
                                    <span class="font-weight-bold text-white font-size-sm">Quiz Report</span>
                                </a>
                            </div>
                        </div>
                    </div>                    
...
<div style="background-color: #ffffff;">
        ...
        <div class="row">
            ...
            <div class="col-xs-4 col-lg-4 col-md-4 col-sm-12">
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body text-center">
                        <span id = "chartLabel" class=" font-weight-bold text-dark" style="font-size: 1.8rem;">
...
if ($_SESSION['view'] == 'view/dashboard.php' && $_SESSION['dashboard_loaded'] == 0) {
    $_SESSION['dashboard_loaded'] = 1;
    
	?>
        <script src="/public/js/modules/dashboard.js"></script>
        <script src="/public/assets/chart.js"></script>
	<?php
}
else {
    $_SESSION['dashboard_loaded'] = 0;
}
?>