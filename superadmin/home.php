...
<html lang="en">
	<!--begin::Head-->
	<head><base href="<?php echo $_SESSION['dir'] ?>">
		<meta charset="utf-8" />
		<title>Alchemia | <?php echo $page_title; ?></title>
		...
		<link href="assets/plugins/custom/datatables/datatables.bundle_old.css" rel="stylesheet" type="text/css" />
		<link href="assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="/public/assets/grabbable.js"></script>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="dashboard">
				<h1><img alt="Logo" class="w-140px" src="<?php echo $config->app_logo() ?>" /> </h1>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="dashboard" class="brand-logo">
							<center><img alt="Logo" class="w-150px" src="<?php echo $config->app_logo() ?>" /> </center>
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<ul class="menu-nav">
								...
								<li class="menu-section">
									<h4 class="menu-text">MEMBERS</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<?php if($_SESSION[$config->SESS().'_ROLE']!="admin"){
									?>
									<li class="menu-item menu-item-submenu adminprofile" aria-haspopup="true" data-menu-toggle="hover">
									<a href="adminprofile" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<li class="menu-item menu-item-submenu useraccount" aria-haspopup="true" data-menu-toggle="hover">
									<a href="useraccount" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											        <polygon points="0 0 24 0 24 24 0 24"/>
										...
										<span class="menu-text">User Account</span>
										<!-- <i class="menu-arrow"></i> -->
									</a>
								...
								<li class="menu-item menu-item-submenu learningmaterial learningactivity" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item learningmaterial" aria-haspopup="true">
												<a href="learningmaterial" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Learning Material</span>
												</a>
											</li>
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
											...
											<!-- <li class="menu-item learningactivity" aria-haspopup="true">
												<a href="learningactivity" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Learning Activity</span>
												</a>
											</li> -->
											<!-- <li class="menu-item product-rating" aria-haspopup="true">
												<a href="product-rating" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-item menu-item-submenu assestmenttask quiz" aria-haspopup="true" data-menu-toggle="hover">
									<a class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<!-- <li class="menu-item assestmenttask" aria-haspopup="true">
												<a href="assestmenttask" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Assestment Task</span>
												</a>
											</li> -->
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
											...
											<li class="menu-item quiz" aria-haspopup="true">
												<a href="quiz" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-item menu-item-submenu assestmenttask report topicquiz" aria-haspopup="true" data-menu-toggle="hover">
									<a class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item report" aria-haspopup="true">
												<a href="report" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Module Quizzes</span>
												</a>
											</li>
											<li class="menu-item topicquiz" aria-haspopup="true">
												<a href="topicquiz" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Lesson Quizzes</span>
												</a>
											</li>											
										</ul>
									</div>
								</li>
								<li class="menu-item menu-item-submenu periodic" aria-haspopup="true" data-menu-toggle="hover">
									<a href="periodic" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<i class="flaticon-squares mr-4"></i>
										</span>										
										<span class="menu-text">Periodic Table</span>
										<!-- <i class="menu-arrow"></i> -->
									</a>									
								</li>								
							</ul>
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
									<!--  <ul class="menu-nav">
										<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here setting" data-menu-toggle="click" aria-haspopup="true">
											<a href="setting" class="menu-link menu-toggle">
												...
												<ul class="menu-subnav">
													<li class="menu-item menu-item-active" aria-haspopup="true">
														<a href="setting" class="menu-link">
															...
															<span class="menu-text">Bypass Password</span>
														</a>
													</li>
												</ul>
											</div>
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder full_name font-size-base d-none d-md-inline mr-3"><?php echo $_SESSION[$config->SESS().'_FNAME'].' '.$_SESSION[$config->SESS().'_LNAME']?></span>
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<div class="symbol-label" style="background-image:url('../images/admin_images/<?php echo $_SESSION[$config->SESS().'_PROFILE']  ?>')"></div>
										</span>
									</div>
								</div>
							</div>
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5 image">
						<div class="symbol-label" style="background-image:url('../images/admin_images/<?php echo $_SESSION[$config->SESS().'_PROFILE']  ?>')"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><span class="full_name"><?php echo $_SESSION[$config->SESS().'_FNAME'].' '.$_SESSION[$config->SESS().'_LNAME']?></span></a>
						<div class="text-muted mt-1"><span class="username"><?php echo $_SESSION[$config->SESS().'_UNAME']?></span></div>
						<div class="navi mt-2">
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary e-mail"><?php echo $_SESSION[$config->SESS().'_EMAIL']?></span>
								</span>
							</a>
							<a href="logout" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5 logout">Sign Out</a>
						</div>
					</div>
				</div>
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade pt-3 pr-5 mr-n5" id="kt_quick_panel_settings" role="tabpanel">
						<form class="form">
							...
							<div class="separator separator-dashed my-6"></div>
							<div class="pt-2">
								<h5 class="font-weight-bold mb-3">Members</h5>
								<div class="form-group mb-0 row align-items-center">
		...
		<script src="assets/plugins/custom/datatables/datatables.bundle_old.js"></script>
		...
		<script src="assets/js/pages/custom/draggable/draggable.js"></script>
		...
		<!-- <script src="assets/js/pages/custom/draggable/draggable-script.js"></script>
		<script src="assets/js/pages/custom/draggable/draggable.min.js"></script>
		<script src="assets/js/pages/custom/draggable/vue.js"></script>
 ...
 -->
		...
		<!-- PACKAGES -->
		<script src="assets/js/pages/crud/search/search-product.js"></script>

	</body>
	<!--end::Body-->
</html>
<script src="/public/js/modules/admin-material.js"></script>
