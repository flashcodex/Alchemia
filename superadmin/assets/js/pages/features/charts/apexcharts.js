        ...
        $.ajax({
            ...
            complete: function(){
                ...
                var options = {
                    ...
                    labels: ['Bronze', 'Silver', 'Gold', 'Bronze (Free)', 'Silver (Free)', 'Gold (Free)'],
                    responsive: [{
                        breakpoint: 480,
                        options: {
                            chart: {
                    ...
                    colors: [primary, success, warning, danger, info, green]
                };
             ...
             success:function(response){
                ...
                if(response != false){
                  if(response.length >= 1){
                     ...
                     chart_count.push(Number(response[0].bronze));
                     chart_count.push(Number(response[0].silver));
                     chart_count.push(Number(response[0].gold));
                     chart_count.push(Number(response[0].bronze_free));
                     chart_count.push(Number(response[0].silver_free));
                     chart_count.push(Number(response[0].gold_free));
