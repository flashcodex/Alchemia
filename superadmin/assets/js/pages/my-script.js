        ...
        switch (String(view)) {            
            ...
            case "learningmaterial": {
                ...
                function all_material() {
                    ...
                    _ajaxrequest("controller/controller.php", "POST", _constructBlockUi("blockPage", false, "Loading..."), _constructForm(["learningmaterial", "all_material", "", search]));
                }
                all_material();
            ...
            case "editmaterial": {
                ...
                function retrieve_main_page_setting() {
                    ...
                    _ajaxrequest("controller/controller.php", "POST", _constructBlockUi("blockPage", false, "Loading..."), _constructForm(["edit_setting_main", "retrieving_setting_main", id, page]));
                }
                ...
                function dropitem() {
                    ...
                    if (page > 0) 
                    {
                        add_quiz = `<div id="add-quiz" class="col-md-6 col-4 p-1" >
                                    <div class="bg-gray-200 rounded-sm p-5" >
                                        <div style="cursor:pointer;" data_arrange="">
            ...
            case "quiz": {
                ...
                function tbl_quiz() {
                    _ajaxrequest("controller/controller.php", "POST", _constructBlockUi("blockPage", false, "Loading..."), _constructForm(["all_quiz", "tbl_quiz"]));
                }
        ...
        switch (type) {
                            ...
                            $(".learningmaterial_not_publish").append(
                                ...
                                '\'">\
					                	<div class="btn-group" role="group" aria-label="Button group with nested dropdown">\
				                            <button type="button" class="btn  btn-primary font-weight-bold edit_material" data-id="' +
                                response[i].id +
                                '"><span class="flaticon flaticon-edit"> Edit</button>\
				                            <button style="background-color:seagreen" type="button" class="btn  text-white font-weight-bold publish_material" data-id="' +
                                response[i].id +
                                '" ><i class="fa fa-check text-white"></i> Publish</button>\
				                    	</div>\
					                    <div class="card-body" >\
                            ...
                            $(".learningmaterial_published").append(
                                ...
                                '\'">\
					                	<div class="btn-group" role="group" aria-label="Button group with nested dropdown">\
				                            <button type="button" class="btn btn-primary font-weight-bold edit_material" data-id="' +
                                response[i].id +
                                '"><i class="flaticon flaticon-edit"></i> Edit</button>\
				                            <button type="button" class="btn  btn-success text-white font-weight-bold unpublish_material" data-id="' +
                                response[i].id +
                                '" ><i class="fa fas fa-arrow-up text-white"></i> Unpublish</button>\
				                    	</div>\
					                    <div class="card-body">\
					                        <span class="card-title font-weight-bolder font-size-h2 mb-0 mt-6 d-block text-hover-info" style="' +
                                color[0] +
            ...
            case "retrieve_pages": {
                if (response.length) {
                    ...
                    for (var i = 0; i <= response.length - 1; i++) {
                        if (response[i].name !== "main_page") {
                            ...
                            $("#pages").append(
                                ...
                                // `<input type="text" class="topic_number-${response[i].page_id}" value="${response[i].number}">` +
                                '<a data-toggle="tab" class="topic-' +
                                response[i].page_id +
                                ' topic_page btn_retrieve_page btn_show btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 btn-block" href="#cover_page" data_name="' +
                                response[i].name +
                                '" data_id="' +
                                response[i].page_id +
                                '">' +
                    ...
                    $("#pages").empty();
                    $("#pages").append(`<a data-toggle="tab" data_id="${response[i].page_id}" href="#cover_page" class="btn_cover_page topic_page btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 btn-block active">Cover page</a>`);
                }
