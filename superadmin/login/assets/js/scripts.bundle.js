...
var KTApp = function() {
    ...
    var initAbsoluteDropdowns = function() {
      ...
      var _loader = function(options) {
        if ($('.spinner').length > 0) {
            $('.spinner').hide();
            $('.blockPage').append('<svg width="100px"  height="100px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-ball" style="background: none;"><circle cx="50" ng-attr-cy="{{config.cy}}" ng-attr-r="{{config.radius}}" ng-attr-fill="{{config.color}}" cy="37.7014" r="13" fill="#3699FF"><animate attributeName="cy" calcMode="spline" values="23;77;23" keyTimes="0;0.5;1" dur="1" keySplines="0.45 0 0.9 0.55;0 0.45 0.55 0.9" begin="0s" repeatCount="indefinite"></animate></circle></svg>').css({
