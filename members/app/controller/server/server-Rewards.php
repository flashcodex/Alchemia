   ...
   public function Fetch_Data()
    {
		...
		$data = array();
		$sql = "SELECT comm_from,amount,DATE_FORMAT(date_created,'%M %d, %Y %h:%i %p') AS date_received,type,IFNULL((SELECT u.username FROM tbl_topup_details d RIGHT JOIN tbl_user u ON u.id=d.user_id WHERE d.txnid=comm_from),'system') AS reward_from FROM tbl_user_commission WHERE owner='$id' ORDER BY date_created DESC";
