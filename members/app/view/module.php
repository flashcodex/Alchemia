<div class="container">
	<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert" style="margin-top: 20px;">
			...
			<div class="alert-text module_name">Module</div>
		</div>
		<!--end::Notice-->
		<div class="row" data-sticky-container="">
			<div class="col-lg-3 col-xl-2">
				<div class="card card-custom sticky" data-sticky="true" data-margin-top="200px" data-sticky-for="1023" data-sticky-class="sticky">
					<div class="card-body p-0">
						<ul class="navi navi-bold navi-hover my-5 list_page" role="tablist">
							<li class="navi-item">
								<a class="navi-link active" data-toggle="tab">
									<span class="navi-text">Link 1</span>
								</a>
							</li>
						</ul>
					</div>
			...
			<div class="col-lg-6 col-xl-8">
				<div class="card card-custom gutter-b example example-compact">
					<div class="card-body cover_page">
