      ...
      case 'sender':
         return 'Alchemia Support Team<support@pamantasanalchemia.com>';
  		...
  		case 'login_attempt':
  		    ...
  		    break;
      case 'get_code':
          return 'Alchemia Admin: Email Verification PIN';
          break;
      case 'lyb_verify':
          return 'Alchemia Admin: User BYPASS PIN';
          break;
      case 'verify_email':
          return 'Alchemia Admin: Confirm Account Email';
          break;
      case 'forgot-pass':
          return 'Alchemia Admin: Account Reset Password';
          break;
      	default:
      		return '';
      		break;
            ...
            return '<div style="background-color:#f2f3f5;padding:20px">
              ...
                          <div style="padding:0px 30px">        
                              <div style="font-size:16px;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:20px">        
                                  ...
                                  <p style="text-align:center; margin: 0;"><a style="text-decoration:none;color:#000"></a><b>Alchemia Support Team</b></p>        
                              </div>
                              <div style="font:11px sans-serif;color:#686f7a">
                              <p style="margin: 0;">© 2021. Alchemia Inc.</p>        
                              </div>        
