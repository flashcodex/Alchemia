...
if(!isset($_COOKIE[$config->cookie_auth()])){
   ...
   exit();
	...
	// echo "Page View ". $page_view;
	// echo "<br>DIR : ". $_SESSION['dir'];
?>
...
<html lang="en">
	<!--begin::Head-->
		<meta charset="utf-8" />
		<head><base href="">
		<title><?php echo 'Alchemia | '.$page_title; ?></title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading"><!--  -->
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<!--begin::Logo-->
			<a href="dashboard">
				<h1><img alt="Logo" src="<?php echo $config->app_logo() ?>" class="max-h-30px" />Alchemia</h1>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			<div class="d-flex align-items-center">
				...
				<span class="symbol symbol-35">
                                                <?php echo ($usercookie['user_image']=="default.png") ? '<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30 text-uppercase">'.($usercookie['user_fname'])[0].'</span>' : '<div class="symbol-label" style="background-image:url(../../images/user_images/'.$usercookie['user_image'].')"></div>'; ?>
                                            </span>
				</button>
			</div>
			<!--end::Toolbar-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="dashboard" class="mr-20">
										<h1 class="text-white"><img alt="Logo" src="<?php echo $config->app_logo() ?>" class="max-h-50px " />Alchemia</h1>
									</a>
									<!--end::Logo-->
														...
														<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark text-hover-primary mb-1 font-size-lg">Cool App</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Awesome SAAS</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark text-hover-primary mb-1 font-size-lg">Claudy Sys</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark text-hover-primary mb-1 font-size-lg">Trilo Service</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark text-hover-primary mb-1 font-size-lg">Bravia SAAS</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark text-hover-primary mb-1 font-size-lg">Express Wind</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:;" class="text-dark text-hover-primary mb-1 font-size-lg">Bruk Fitness</a>
																	<span class="text-muted">Web Design &amp; Development</span>
																</div>
															</div>
														</div>
														<div class="d-flex flex-center pt-7">
															<a href="javascript:;" class="btn btn-light-primary font-weight-bold text-center">See All</a>
														</div>
													</div>
												...
												<div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
													<div class="d-flex align-items-center justify-content-between p-8">
														<div class="d-flex flex-column mr-2">
															<a href="javascript:;" class="font-weight-bold text-dark-75 font-size-lg text-hover-primary">iBlender</a>
														...
														<a href="javascript:;" class="symbol symbol-70 flex-shrink-0">
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														<div class="d-flex flex-column mr-2">
															<a href="javascript:;" class="font-weight-bold text-dark-75 font-size-lg text-hover-primary">SmartCleaner</a>
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														<div class="d-flex flex-column mr-2">
															<a href="javascript:;" class="font-weight-bold text-dark-75 font-size-lg text-hover-primary">CameraMax</a>
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														<div class="d-flex flex-column mr-2">
															<a href="javascript:;" class="font-weight-bold text-dark text-hover-primary">4DPrinter</a>
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex flex-column text-right pr-3">
												<span class="text-white opacity-50 font-weight-bold font-size-sm d-none d-md-inline mr-1"><?php echo $usercookie['user_fname']?></span>
												<span class="text-white font-weight-bolder font-size-sm d-none d-md-inline f_name">#<?php echo $usercookie['user_name']?></span>
											</div>
							...
							<div class="container">
								...
								<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										<!--begin::Header Nav-->
										<ul class="menu-nav">
											<li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open dashboard" href-data="dashboard" data-menu-toggle="hover" aria-haspopup="true">
												<a href="dashboard" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="fas fa-book-open text-info icon-2x mr-3"></i>Modules</span>
													<!-- <span class="menu-desc">Table &amp; Records</span> -->
												</a>
											</li>
											<li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open report" href-data="report" data-menu-toggle="hover" aria-haspopup="true">
												<a href="report" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="flaticon-list text-info icon-2x mr-3"></i>Reports</span>
													<!-- <span class="menu-desc">Table &amp; Records</span> -->
												</a>
											</li>
											<!-- <li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open games" href-data="games" data-menu-toggle="hover" aria-haspopup="true">
												<a href="games" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="flaticon-layer text-info icon-2x mr-3"></i>Atomic Calculation</span>
												</a>
											</li>-->
											<!-- <li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open periodic" href-data="periodic" data-menu-toggle="hover" aria-haspopup="true">
												<a href="periodic" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="flaticon-squares text-info icon-2x mr-3"></i>Periodic Table</span>
												</a>
											</li> -->
											<li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open periodic" href-data="table" data-menu-toggle="hover" aria-haspopup="true">
												<a href="table" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="flaticon-squares text-info icon-2x mr-3"></i>Periodic Table</span>
												</a>
											</li>
											<li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open games" href-data="games" data-menu-toggle="hover" aria-haspopup="true">
												<a href="games" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="flaticon-layer text-info icon-2x mr-3"></i>Games</span>
												</a>
											</li>
											<li class="menu-item menu-item-open  menu-item-submenu menu-item-rel menu-item-open games" href-data="games" data-menu-toggle="hover" aria-haspopup="true">
												<a href="calculate" class="menu-link menu-toggle">
													<span class="menu-text text-info"><i class="fa fa-calculator text-info icon-2x mr-3"></i>Atomic Calculator</span>
												</a>
											</li>											
										</ul>
										<!--end::Header Nav-->
					...
					<div class="footer bg-white d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://pamantasanalchemia.com/" target="_blank" class="text-dark-75 text-hover-primary">Alchemia</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark order-1 order-md-2" >
								<a href="credits" class="nav-link pr-3 pl-0 agreement">Credits</a>
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5 symbol-light-primary">
                    <?php echo ($usercookie['user_image']=="default.png")? '<span class="font-size-h3 symbol-label font-weight-boldest text-uppercase">'.($usercookie['user_fname'])[0].'</span>' : '<div class="symbol-label" style="background-image:url(../../images/user_images/'.$usercookie['user_image'].')"></div>'; ?>
                        
                        <i class="symbol-badge bg-success"></i>
                    </div>
					<div class="d-flex flex-column">
						<a href="javascript:;" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary full_name"><?php echo $usercookie['user_fname']." ".$usercookie['user_lname'];?></a>
						...
						<div class="navi mt-2">
							<a href="javascript:;" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary"><?php echo $usercookie['user_email']?></span>
								</span>
							</a>
				...
				<div class="navi navi-spacer-x-0 p-0">
					<a href="profile" class="navi-item profile">
						<div class="navi-link">
		...
		<!--end::Chat Panel-->
			<div id="TopupModal" class="modal-2 ">
					<span class="close-2">&times;</span>
					<img class="modal-content-2" id="img01">
					<div id="caption"></div>
			</div>

			<div class="modal fade" id="my-modal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true" style=" padding-top: 150px;">
			        ...
			        <div class="modal-content">
				            ...
				            <div class="modal-body">
				                <div data-scroll="true" data-height="300">
				                    <p class="title-header-description"></p>
				                <div>
				            </div>
			        </div>
			    </div>
...
<script src="/public/js/modules/helper.js"></script>
...
if (strpos($clean_url, '?topic=') !== false) 
{	
	$next_arr = explode('=', $clean_url);
	$next_topic = $next_arr[1];
}
else
{
	$next_topic = '';
...
?> <input id="next_topic" type="hidden" value="<?php echo $next_topic ?>"> <?php

if (strpos($subdir, 'material') !== false || strpos($subdir, 'module') !== false) 
{
	$arr = explode('_', $subdir);
	$material = $arr[1];

	?> <input id="material_page" type="hidden" value="<?php echo $material ?>">  <script src="/public/js/modules/material.js"></script> <?php
}
else if (strpos($subdir, 'topic') !== false) 
{
	$arr = explode('_', $subdir);
	$material = $arr[1];

	?> <input id="topic_page" type="hidden" value="<?php echo $material ?>">  <script src="/public/js/modules/topic.js"></script> <?php
}
?>