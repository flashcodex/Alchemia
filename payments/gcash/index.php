...
if(!isset($_COOKIE[$config->cookie_user()])){
    ...
    $payment_title='GCASH';
    $payment_logo='../../images/transaction/gcash.png';
$amount=0;
$page_title='Payment';
$logo='../../trans4mersadminv12021/assets/media/bg/bg-15.png';
?>
            					...
            					<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
            		                <div class="col-xl-12 col-xxl-7">
                                        ...
                                        <div class="alert alert-custom alert-light-primary fade show mb-5" role="alert">
                                            ...
                                            <div class="alert-text">Please send your payment to <b>Rafael De Andres</b><br> GCASH Number  <i>09957492845</i></div>
                                        ...
                                        <form class="form mt-0 mt-lg-10" id="kt_form_gcash" name="kt_form_gcash" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-lg input-group-solid">
                                                                ...
                                                                <input type="number" class="form-control form-control-solid form-control-lg" name="mobile"  placeholder="Mobile" value="" />
                                                            </div>
                                                            <span class="form-text text-muted">Please enter account mobile.</span>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Amount:</label>
                                                            <input  type="text" class="form-control form-control-solid form-control-lg" name="t_amount" placeholder="Ex: 10000.00" id="amount"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="image-input image-input-outline" id="kt_gcash_image" style="width: 100%;height:500px ;">
                                                            <img src="../../images/transaction/gcash-avatar.jpg" class="temp_img image-input-wrapper" style="width: 100%;height:500px ;">
